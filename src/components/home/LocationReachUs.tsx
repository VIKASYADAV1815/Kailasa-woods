...
export default function LocationReachUs() {
  ...
  return (
    <section id="location" className="bg-kw-forest text-kw-offwhite relative overflow-hidden flex flex-col lg:flex-row w-full">
      
      {/* Left Content (Text) */}
      <div ref={ref} className="w-full lg:w-1/2 py-10 md:py-16 lg:py-20 flex justify-center lg:justify-end relative z-10 bg-kw-forest">
        <div className="w-full max-w-[640px] px-6 md:px-12 lg:pr-16 lg:pl-12 flex flex-col justify-center">
          ...
          >
            <div>
              ...
              <motion.h2 variants={itemVariants} className="font-serif text-3xl md:text-4xl lg:text-5xl mb-3 leading-tight">
                Tucked Away, <br />
                <span className="italic text-kw-sage">Yet Accessible.</span>
              </motion.h2>
              <motion.p variants={itemVariants} className="text-kw-offwhite/80 text-sm md:text-base leading-relaxed font-light max-w-lg">
            ...
            <motion.div variants={itemVariants} className="flex flex-col gap-5 mt-2">
              <div className="flex flex-col group">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-serif">~ 35 km <span className="text-xs font-sans text-kw-offwhite/60 ml-2">/ 60 mins drive</span></p>
                </div>
              </div>
              ...
              <div className="flex flex-col group">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-serif">~ 12 km <span className="text-xs font-sans text-kw-offwhite/60 ml-2">/ 35 mins drive</span></p>
                </div>
              </div>
              ...
              <div className="flex flex-col group">
                ...
                <div>
                  ...
                  <p className="text-xl md:text-2xl font-serif">~ 25 km <span className="text-xs font-sans text-kw-offwhite/60 ml-2">/ 50 mins drive</span></p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <div className="w-full lg:w-1/2 h-[350px] md:h-[450px] lg:h-auto relative z-0">
        ...
        >
          <iframe 
            ...
            width="100%" 
            height="100%" 
            style={{ border: 0, filter: "grayscale(100%) invert(92%) contrast(83%) sepia(50%) hue-rotate(80deg)" }} 
            allowFullScreen={false} 
            loading="lazy" 
            referrerPolicy="no-referrer-when-downgrade"
            className="w-full h-full object-cover"
          ></iframe>
          <div className="absolute inset-0 pointer-events-none mix-blend-overlay bg-black/10" />
        </motion.div>
      </div>
